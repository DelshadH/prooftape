...
| PT-G09 | `npm run security` combines npm audit, license allowlist, production-install-script check, tracked-source secret scan, and policy scans for both the permanent OIDC release workflow and the one-time real-alpha bootstrap workflow. |
