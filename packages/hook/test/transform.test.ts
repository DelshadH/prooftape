...
describe("transformApplicationSource", () => {
  it("instruments ESM named calls and object methods without replacing bindings", () => {
    ...
    expect(result.source).toContain('invoke("fixture","add",sum,void 0,[1, 2])');
    expect(result.source).toContain(
      'invoke("fixture","toolbox.parse",toolbox.parse,toolbox,["x"])',
    );
  ...
  it("instruments CommonJS namespace methods and callable exports", () => {
    ...
    expect(result.issues).toEqual([]);
    expect(result.source).toContain(
      'invoke("fixture","add",fixture.add,fixture,[1, 2])',
    );
    expect(result.source).toContain(
      'invoke("fixture","default",fixture,void 0,[3])',
    );
  });
  ...
  it("instruments nested dependency calls in evaluation order", () => {
    ...
    expect(result.source).toContain(
      'invoke("fixture","inner",fixture.inner,fixture,[1])',
    );
  });
